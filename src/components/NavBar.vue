        ...
        <v-card>
          ...
          <v-list>
            ...
            <v-list-item router to="/studio">
              ...
              <v-list-item-title>MiniTube Studio</v-list-item-title>
            </v-list-item>
        ...
        <v-list dense nav class="py-0" tag="div">
          ...
          >
            <v-app-bar-nav-icon
              ...
              class="mr-5"
            ></v-app-bar-nav-icon>
            <v-toolbar-title class="font-weight-bold">MiniTube</v-toolbar-title>
          </v-list-item>
...
export default {
  data: () => ({
    ...
    items: [
      ...
      {
        header: 'MORE FROM MINITUBE',
        pages: [
          {
            title: 'MiniTube Premium',
            link: '#vp',
            icon: 'mdi-youtube'
          },
          {
