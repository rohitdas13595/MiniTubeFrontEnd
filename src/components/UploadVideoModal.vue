    ...
    <v-card>
      ...
      <v-card-actions v-if="!uploaded">
        <p class="text-center grey--text caption px-12 px-xs-0">
          By submitting your videos to MiniTube, you acknowledge that you agree
          to MiniTube's Terms of Service and Community Guidelines. Please be sure
    ...
    return {
      ...
      rules: [
        (value) =>
          ...
          `Video size should be less than 1000 MB!, ${value.size}`,
      ],
      categoriesTitles: [],
      categories: [],
